...
from .views import index, channel_search, add_channel, generate, get_progress, get_next_rows, deletechannel
...
urlpatterns = [
    ...
    path('delete_channel/<channel_id>/', deletechannel, name='delete-channel'),
]